...
<div class="row">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"> Ubah Tap List</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url();?>/dashboard/save_tap_list_edit">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name Tap</label>
                      <input class="form-control" name="id_level" type="hidden" value="<?php echo $tap_list_select->id_tap_list;?>"/>  
                                        <input class="form-control" name="name_tap" type="text" value="<?php echo $tap_list_select->name_tap;?>"/>  
                                
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nilai</label>
                               <input type='number' class="form-control" name="nilai_tap"  value="<?php echo $tap_list_select->nilai_tap;?>"/>  
