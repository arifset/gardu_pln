...
<div class="row">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"> Ubah Oil Level</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url();?>/dashboard/save_oil_list_edit">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Level Oil</label>
                      <input class="form-control" name="id_level" type="hidden" value="<?php echo $oil_list_select->id_level;?>"/>  
                                        <input class="form-control" name="oil_level_list" type="text" value="<?php echo $oil_list_select->name_level;?>"/>  
                                
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nilai</label>
                               <input type='number' class="form-control" name="oil_nilai_list"  value="<?php echo $oil_list_select->nilai_level;?>"/>  
