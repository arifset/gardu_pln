...
<div class="row">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url();?>/dashboard/add_name_trafo_list">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name Trafo</label>
                      <input class="form-control" name="name_trafo" type="text" value="<?php echo set_value('name_trafo');?>"/><?php echo form_error('name_trafo');?>           
                    </div>
