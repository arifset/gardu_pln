...
<div class="row">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Ubah Tipe Trafo List</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="<?php echo site_url();?>/dashboard/save_tipe_trafo_list_edit">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name Tipe Trafo</label>

                      <input class="form-control" name="id_level" type="hidden" value="<?php echo $tipe_trafo_list_select->id_type_trafo;?>"/>
                      <input class="form-control" name="tipe_trafo" type="text" value="<?php echo $tipe_trafo_list_select->name_type_trafo?>" required/>           
                    </div>
